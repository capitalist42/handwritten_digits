defmodule HandwrittenDigitsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HandwrittenDigitsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HandwrittenDigitsWeb.Gettext, "errors", msg, opts)
    end
  end
